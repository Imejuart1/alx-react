import getAllNotificationsBuyUser, { getAllNotificationsByUser, normalized } from "./notifications";
...
describe("Test for Notifications.js", () => {
  it("verify that the function returns the correct data", () => {
    ...
    it("should have a correct message entity", () => {
      const user = {
        age:25,
        email: "poople.sanders@holberton.nz",
        id: "5debd764a7c57c7839d722e9",
        name: { first: "poople", last:"Sanders" },
    ...
    it("should have a correct notifications entity", () => {
      ...
      expect(normalized.entities.notification["5debd7642e815cd350407777"]).toEqual(notificationsDummy);
    });
    });
